...
class User(AbstractBaseUser,PermissionsMixin):
    username = models.CharField(
        ...
        validators=[validators.RegexValidator(r'^[a-zA-Z][a-zA-Z0-9_\.]+$',_('Enter a valid username starting with a-z.'))],
        error_messages={
    ...
    phone_number = models.BigIntegerField(
        ...
        null= True,
        blank=True,
        validators=[validators.RegexValidator(r'^989[0-3,9]\d{8}$',_('Enter a valid number phone'),'invalid')],
        error_messages={
